...
class MySql {
	...
	public function __construct($bd = "principal") {
		$this->conn = mysqli_connect("localhost", "root", "psyduck", $bd);
	}
	...
	public function Call($procedure, $values = array()) {
		...
		return $this->Query("call $procedure ".implode(", ", $values));
	}
